...
description: "Use when the user wants a requirements interview grounded in the project's domain model, glossary, and ADRs, followed by Codex adversarial plan review; invokes /grill-with-docs-codex; or wants alignment, updated docs, and a second-model check before high-stakes work."
---
