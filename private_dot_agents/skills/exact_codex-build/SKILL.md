---
name: codex-build
description: "Use when delegating implementation of a written plan or frozen spec to Codex, including refactors, mechanical migrations, known-repro bug fixes, and tests. Triggers on /codex-build or requests for Codex to build or implement. Excludes tiny edits, design, reviews, and session-tool-dependent work."
---
