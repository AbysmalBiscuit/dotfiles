---
name: codex-review
description: "Use when a written plan or spec needs Codex adversarial review before implementation, especially for high-stakes work, or the user invokes /codex-review or asks for a second-model plan check. For a requirements interview first, use /grill-me-codex. Excludes code review and trivial changes."
