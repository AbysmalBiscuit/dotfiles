---
name: kysely-cleanup-kc
description: Use when a kysely-migration PR's implementation is finished and you want to clean it up, validate it (including flag-gated TDD), and hand it off for review.
