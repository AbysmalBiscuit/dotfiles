---
description: Validate that the TDD tests added for this fix/feature actually exercise the bug end-to-end and prove the fix — not ceremony unit tests that pass regardless [vt]
