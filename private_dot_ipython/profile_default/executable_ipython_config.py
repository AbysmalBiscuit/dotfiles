...
#  Default: "Python 3.9.0 (default, Dec  3 2020, 16:06:57) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.19.0 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.9.0 (default, Dec  3 2020, 16:06:57) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.19.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.TerminalInteractiveShell.banner1 = "Python 3.9.0 (default, Dec  3 2020, 16:06:57) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.19.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.TerminalInteractiveShell.highlighting_style = 'abc'
...
class Colors:
    background: str = "#141F2E"
    default: str = "#f5f5f5"
    comment: str = "#7f7f7f"
    comment_multiline: str = "italic #7f7f7f"
    string: str = "#11cf45"
    static: str = "#FFD700"
    static_alt: str = "#00CED1"
    documentation: str = "italic #50F050"
    number: str = "#ff9d00"
    keyword: str = "bold #558eff"
    type: str = "#91CCFF"
    builtin: str = "bold #aa00aa"
    builtin_nobold: str = "nobold #aa00aa"
    decorator: str = "nobold #FC7A00"
    preprocessor: str = "bold #FC7A00"
    function: str = "bold #f5f5f5"
    constant: str = "#FFA07A"
    namespace: str = "#80ffbb"
    label: str = "bold #FC7A00"
    literal: str = "#A0FFA0"
    shebang: str = "italic #0088ff"
    error: str = "underline bold #FF8080"
    error_simple: str = "nounderline nobold #FF8080"
    diff_ignore: str = "#777777"
    diff_added_line: str = "#3ad900"
    diff_removed_line: str = "#ffee80"
    diff_changed_line: str = "#ff9d00"
    diff_diff_file: str = "bold #0088ff"
    diff_location: str = "#0088ff"
    diff_special_case: str = "bold #ff0044"
    emphasis: str = "italic #558eff"
    markup_bold: str = "bold #558eff"
    highlight: str = "bg:#375780 #f5f5f5"
    escape: str = "bold #83A6C1"
    line_numbers: str = "#808080"
    line_numbers_bg: str = "#282828"


c.TerminalInteractiveShell.highlighting_style_overrides = {  # noqa: F821
    ...
    Keyword.Constant: Colors.keyword,
    Keyword.Declaration: Colors.keyword,
    Keyword.Namespace: Colors.keyword,
    Keyword.Pseudo: Colors.keyword,
    Keyword.Reserved: Colors.keyword,
    Keyword.Type: Colors.type,
    Name: Colors.default,
    Name.Attribute: "",
    Name.Builtin: Colors.builtin,
    Name.Builtin.Pseudo: Colors.decorator,
    Name.Class: Colors.function,
    Name.Constant: Colors.constant,  # consider using keyword instead
    Name.Decorator: Colors.decorator,
    Name.Entity: Colors.escape,
    Name.Exception: Colors.builtin,
    Name.Function: Colors.function,
    Name.Function.Magic: Colors.builtin,
    Name.Property: "",
    Name.Label: Colors.label,
    Name.Namespace: Colors.namespace,
    Name.Other: "",
    Name.Tag: "",
    Name.Variable: Colors.default,
    Name.Variable.Class: "",
    Name.Variable.Global: "",
    Name.Variable.Instance: Colors.decorator,
    Name.Variable.Magic: Colors.builtin_nobold,
    Literal: Colors.literal,
    Literal.Date: "",
    String: Colors.string,
    String.Affix: Colors.string,
    String.Backtick: "",
    String.Char: "",
    String.Delimiter: "",
    String.Doc: Colors.documentation,
    String.Double: "",
    String.Escape: Colors.escape,
    String.Heredoc: Colors.keyword,
    String.Interpol: Colors.escape,
    String.Other: "",
    String.Regex: Colors.escape,
    String.Single: "",
    String.Symbol: "",
    ...
    Operator.Word: Colors.keyword,
    Punctuation: Colors.default,
    Comment: Colors.comment,
    Comment.Hashbang: Colors.shebang,
    Comment.Multiline: Colors.comment_multiline,
    Comment.Preproc: Colors.preprocessor,
    Comment.PreprocFile: Colors.string,
    Comment.Single: "",
    Comment.Special: "",
    Generic: Colors.builtin_nobold,
    Generic.Deleted: Colors.diff_removed_line,
    Generic.Emph: Colors.emphasis,
    Generic.Error: Colors.error,
    Generic.Heading: Colors.diff_diff_file,
    Generic.Inserted: Colors.diff_added_line,
    Generic.Output: "",
    Generic.Prompt: "",
    Generic.Strong: Colors.markup_bold,
    Generic.Subheading: Colors.diff_location,
    Generic.Traceback: Colors.error_simple,
    # Traceback
    # "background_color": Colors.background,
    # "highlight_color": Colors.highlight,
    # "line_number_color": Colors.line_numbers,
    # "line_number_background_color": Colors.line_numbers_bg,
}
## Total length of command history
