...
if status is-interactive
    ...
    # (Default: '')
    set -gx fish_lsp_log_file ~/.local/state/nvim/fish_lsp.log
    ...
    #           '**/docker/**'])
    set -gx fish_lsp_ignore_paths '**/.git/**' '**/node_modules/**' '**/containerized/**' '**/docker/**' '/mnt/c/**'
    ...
    # (Default: 5)
    set -gx fish_lsp_max_workspace_depth 4
