...
Reads the live file on stdin, merges .settings.baseline.json into it under
.settings.rules.toml, writes the result to stdout. See
...
from engine.codecs import JsonCodec  # noqa: E402
