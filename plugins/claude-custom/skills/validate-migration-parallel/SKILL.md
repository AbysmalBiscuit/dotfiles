---
name: validate-migration-parallel
description: "Run kysely-migration validation, fanning the independent checks out to parallel subagents. Use when the user invokes $validate-migration-parallel or asks for this workflow."
---
