---
name: issue-setup-migration
description: "Set up an issue worktree via $issue-setup for a kysely-migration sweep issue Use when the user invokes $issue-setup-migration or asks for this workflow."
---
