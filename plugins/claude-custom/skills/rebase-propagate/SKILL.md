---
name: rebase-propagate
description: "Rebase the current branch onto origin/staging, resolve conflicts with user input, force-push safely, and propagate dependent branches. Use when the user invokes $rebase-propagate or asks for this workflow."
---
